export const wompiConfig = {
  ...
  eventsSecret: process.env.WOMPI_EVENTS_SECRET || 'stagtest_events_2PDUmhMywUkvb1LvxYnayFbmofT7w39N',
  integritySecret: process.env.WOMPI_INTEGRITY_SECRET || 'stagtest_integrity_nAIBuqayW70XpUqJS4qf4STYiISd89Fp',
  currency: 'COP',
  environment: 'sandbox',
};
